            ...
            .append("g")
                ...
                .on("click", function(d) {
                    ...
                    if(committee_id !== "none") {
                        window.open("https://www.fec.gov/data/committee/" + committee_id + "/?tab=independent-expenditures-committee&cycle=2016", "_blank");
                    }
                });
        ...
        var image = node_inner_g
            .append("image")
                ...
                .on("click", function(d) {
                    ...
                    window.open("https://www.fec.gov/data/candidate/" + candidate_id + "/?election_full=true&cycle=2016", "_blank");
                });
